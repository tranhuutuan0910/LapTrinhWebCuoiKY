                    ...
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="mt-10 pt-2 text-lg-end">
                                <button type="button" class="btn btn-outline-dark btn-rounded btn-sm my-0" onclick="location.href='SinhVien.jsp'">
                            ...
                            <form class="d-flex justify-content-md-around">
                                ...
                                <script type="text/javascript">
                                    function moreInfo() {
                                        alert("Họ Và Tên: Hà Minh Quân" +
                                            "\nMã Số Sinh Viên: 3120421016" +
                                            "\nKhoa: Công Nghệ Thông Tin" +
                                            "\nGiới Tính: Nữ " +
                                            "\nTên Khoá Học: Chuẩn Đầu Ra Ngoại Ngữ");
